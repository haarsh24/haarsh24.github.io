...
const Contact = () => (
  <Layout className="outerPadding">
    <Layout className="container">
      <SEO
        title="Contact"
        description="Hello folks harsh here. You can contact me through the contact form on this page.
                    ...
                    Find me on github - haarsh24."
        path="/contact"
        keywords={['Kumar', 'Harsh ', 'FullStack developer', 'Javascript', 'ReactJS', 'NodeJS', 'Gatsby', 'technology']}
      />
      <Header />
      <SidebarWrapper>
